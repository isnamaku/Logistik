                ...
                <div class="row">
                    <div class="col-md-6">
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" style="background-color: #E5E5E5" class="form-control" name="nip_penerima" id="nip_penerima" value="<?= $post['nip_penerima'] ?>">
                        </div>
                        <div class="form-group">
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" style="background-color: #E5E5E5" class="form-control" name="telp_penerima" id="telp_penerima" value="<?= $post['telp_penerima'] ?>">
                        </div>
                    </div>
                    <div class="col-md-6">
