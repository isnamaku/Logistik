            ...
            <form action="<?= base_url()?>anggota/a_print" target="_blank" method="POST" >
                ...
                <div class="card shadow my-4 mb-4">
                    ...
                    <button type="submit" href="<?= base_url('anggota/a_print'); ?>" type= "submit" class="btn btn-user" style="background-color: #F69133; color: #000000;font-weight:bold; float:right;" target=_blank><i class="fas fa-print"></i> Cetak</button>
                        <a href="<?= base_url() ?>anggota/barang_masuk" class="btn mr-3" style="background-color: #F69133; color:#000000; font-weight:bold; float:right;">Batal</a>
                    </form>
